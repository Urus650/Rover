...
OutputControler controleur(Capteurs capteurs,bool button_emergency){
...
int main(){
    ...
    Capteurs capteurs = {
      .capteur_pression = 0, 
      .capteur_temperature = 0,
      .capteur_radar = {500,500,500,500,500}
    };
    while(true){
        DebugInput(capteurs);
        output = controleur(capteurs,button_emergency);
        usleep(pas_echantillonage*1000000);
        DebugOuput(output);
    }
